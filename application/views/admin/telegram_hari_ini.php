...
<div class="card">
<div class="card-header"><h3><?php echo $judulhalaman.' '.tanggal($tanggal);?></h3></div>
<div class="card-body">
<div class="table-responsive">
<table class="table table-hover table-striped table-bordered">
<tr align="center"><td width="30"><strong>No.</strong></td><td width="20%"><strong>ID Telegram</strong></td><td><strong>Pesan</strong></td><td width="20%"><strong>Waktu</strong></td><td width="15%"><strong>Status</strong></td><td width="50"><strong>Aksi</strong></td></tr>
	<?php
	$query = $this->db->query("select * from `telegram` where `waktu` like '$tanggal%' order by waktu DESC");
	$nomor=1;
	foreach($query->result() as $b)
	{
		...
		echo "<tr><td>".$nomor."</td><td>".$chat_user."</td><td>".$b->pesan."</td><td>".$b->waktu."</td>";
		echo "<td align=\"center\">".$terkirim."</td><td align=\"center\">".$link_hapus."</a></td></tr>";
		$nomor++;
	}
	?>
	</table></div>

...
// /bukulck/2016/2/1422/akhir/2013
						?>	
						<a href="javascript:;"  onClick="window.open('<?php echo base_url();?>pdf_report/bukulck/<?php echo substr($thnajaran,0,4).'/'.$semester.'/'.$a->nis;?>/akhir/2015','yes','scrollbars=yes,width=550,height=400')"><span class="glyphicon glyphicon-print"></span></a>
						<?php
					}
					elseif($kurikulum == '2013')
					{
						?>	
						<a href="javascript:;"  onClick="window.open('<?php echo base_url();?>pdf_report/bukulck/<?php echo substr($thnajaran,0,4).'/'.$semester.'/'.$a->nis;?>/akhir/2013','yes','scrollbars=yes,width=550,height=400')"><span class="glyphicon glyphicon-print"></span></a>
						<?php
					}
					else
					{
		...
		if($page=='10')
		{
			...
			foreach($ta->result() as $a)
			{
				...
				echo '<td>'.$adayangbelumdikunci.' '.$mapel.'</td><td align="center">';
						?>	
						<a href="javascript:;"  onClick="window.open('<?php echo base_url();?>pdf_report/bukurapor/<?php echo substr($thnajaran,0,4).'/'.$semester.'/'.$a->nis;?>','yes','scrollbars=yes,width=550,height=400')"><span class="glyphicon glyphicon-print"></span></a>
						<?php
				echo '</td></tr>';
				$nomor++;
			}

...
//============================================================+
// Nama Berkas 		: nilai_akhir_peserta_un_xls.php
...
$kelase = berkas($kelas);
$mapele = berkas($mapel);
$filename = 'daftar_nilai_akhir_peserta_ujian_nasional_tahun_'.$thnajarane.'_'.$mapele.'_kelas_'.$kelase.'.xls'; 
...
{	
	...
	foreach($tb->result() as $b)
	{
		...
		$this->excel->getActiveSheet()->setCellValue('E'.$baris,$b->kog);
		$this->excel->getActiveSheet()->setCellValue('F'.$baris.'',$b->psi);

...
if($v == 'v3')
{
	echo '<h2>Unduh Data Kelas</h2>';
}
elseif($v == 'v2')
{
	echo '<h2>Unduh Data Peserta UBK format TSV</h2>';
}
elseif($v == 'v8')
{
	echo '<h2>Unduh Data Peserta UBK untuk cetak kartu</h2>';
}

elseif($v == 'v6')
{
	echo '<h2>Unduh Data Peserta UAMBNBK</h2>';
}

else
{
	echo '<h2>Unduh Data Peserta UBK format Excel</h2>';
}

$xloc = base_url().'tatausaha/pesertatesdaring/'.$v;
$kelasx ='';
$adamapel = 0;
//thnajaran

...
<div class="container-fluid">
	...
	<div class="card-body">
<?php
$xloc = base_url().'tatausaha/unduhraporexcel';
?>
...
if(empty($tahun1))
	...
	{
		?>
		<div class="form-group row"><div class="col-sm-3"><label class="control-label">Mapel / Kelas</label></div><div class="col-sm-9">
		<select name="id_mapel" onChange="MM_jumpMenu('self',this,0)" class="form-control">
		<?php
		echo '<option value=""></option>';
		$ta = $this->db->query("select * from `m_mapel` where `thnajaran`= '$thnajaran' and `semester` = '$semester' order by `kelas`, `mapel` ASC");

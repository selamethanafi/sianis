...
<?php echo form_open('tatausaha/cetakpkgtambahan','class="form-horizontal" role="form"');
...
<?php
	...
	{
       	echo '<option value="'.$a->kode.'">'.$a->nama_tanpa_gelar.' '.$a->nama.'</option>';
	}
	echo '</select></div></div>';
	echo '<p class="text-center"><input type="submit" value="Lanjut" class="btn btn-primary"></p>';
?>
</form>
</div></div></div>

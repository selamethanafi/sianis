...
//============================================================+
// Nama Berkas 		: nilai_akhir_mapel.php
...
<?php echo form_open('tatausaha/nilaiakhirmapel','class="form-horizontal" role="form"');?>
...
if ((empty($thnajaran)) or (empty($kelas)) or (empty($mapel)))
	...
	echo '</select></div></div>
<div class="form-group row row"><div class="col-sm-3"><label class="control-label">Mata Pelajaran</label></div><div class="col-sm-9"><select name="mapel" class="form-control">';
	echo "<option value=''></option>";

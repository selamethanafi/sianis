...
<?php echo form_open('pdf_kartu_tes/tertentu','class="form-horizontal" role="form"');?>
...
<p class="text-center"><input type="submit" value="Cetak Kartu" class="btn btn-primary"></p>
</form>
</div></div></div>

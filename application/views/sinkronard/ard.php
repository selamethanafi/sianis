...
//============================================================+
// Dimutakhirkan	: Sel 01 Jan 2019 21:41:42 WIB 
// Nama Berkas 		: ard.php
...
if($hal == 'tanggapanwalikelas')
{
	...
	<div class="card">
		...
		{
			//selanjutnya
			echo '<p class="text-center"><a href="'.base_url().'sinkronard/ard/tanggapanwalikelas/'.$id_walikelas.'/'.$next.'" class="btn btn-primary">Selanjutnya</a></p>';
		}
		elseif(($nomor < $cacahsiswa) and ($nomor > 0))
		{
			echo '<p class="text-center"><a href="'.base_url().'sinkronard/ard/tanggapanwalikelas/'.$id_walikelas.'/'.$prev.'" class="btn btn-primary">Sebelumnya</a> <a href="'.base_url().'sinkronard/ard/tanggapanwalikelas/'.$id_walikelas.'/'.$next.'" class="btn btn-info">Selanjutnya</a></p>';
		}
		elseif($nomor == $cacahsiswa)
		{
			echo '<p class="text-center"><a href="'.base_url().'sinkronard/ard/tanggapanwalikelas/'.$id_walikelas.'/'.$prev.'" class="btn btn-primary">Sebelumnya</a></p>';
		}
		else
		{
		}
		...
		<iframe src="<?php echo base_url().'sinkronard/tanggapanwalikelas/'.$id_walikelas.'/'.$nomor.'/'.$ulang;?>" width="100%" height="200"></iframe>
<?php
}?>
</div></div></div>

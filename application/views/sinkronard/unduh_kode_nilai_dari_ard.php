...
//============================================================+
// Dimutakhirkan	: Sel 01 Jan 2019 21:42:41 WIB 
// Nama Berkas 		: unduh_kode_nilai_dari_ard.php
...
if(count($query->result())>0)
{
	...
	if($gagal == 0)
	{
		echo '<p><a href="'.base_url().'sinkronard/fkirimnilaiharian/'.$id_mapel.'" class="btn btn-primary"><span class="fa fa-upload"></span>   <b>Kirim Nilai ke ARD</b></a></p>';
	}
	else
	{
		echo '<p><a href="'.base_url().'sinkronard/unduhkodenilai/'.$id_mapel.'" class="btn btn-primary"><span class="fa fa-download"></span>   <b>Unduh Kode Nilai Lagi</b></a> <a href="'.base_url().'sinkronuard/fkirimnilaiharian/'.$id_mapel.'" class="btn btn-info"><span class="fa fa-upload"></span>   <b>Kembali</b></a></p>';
	}

...
<?php
$xloc = base_url().'sinkronard/formdeskripsi';
...
if(!empty($id_mapel))
{
	echo form_open_multipart('sinkronard/prosesunggahdeskripsi/'.$id_mapel,'class="form-horizontal" role="form"');?>
format csv
<p>"nis","nama","deskripsi_pengetahuan","deskripsi_keterampilan"</p>

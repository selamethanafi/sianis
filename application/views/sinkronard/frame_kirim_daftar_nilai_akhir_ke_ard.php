...
//============================================================+
// Dimutakhirkan	: Sel 01 Jan 2019 21:39:05 WIB 
// Nama Berkas 		: frame_kirim_daftar_nilai_akhir_ke_ard.php
...
<div class="card">
<div class="card-body"><h2>Kirim Nilai Akhir ke ARD</h2>
<?php
...
Kode Kelas ARD <?php echo $school_class_id;?> Kode Mapel ARD <?php echo $subjects_value;?><br />
	...
	{
		echo '<div class="alert alert-danger">Belum ada kode nilai dari ARD</div>';
	}
}
else
{

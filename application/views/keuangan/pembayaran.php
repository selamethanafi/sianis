...
<div class="card-body">
<?php echo form_open('keuangan/cetakpembayaran','class="form-horizontal" role="form"');?>
...
?>
<p class="text-center"><input type="submit" value="Tampilkan Data Pembayaran" class="btn btn-primary"></p>
</form>
</div></div></div>

...
//============================================================+
?>
<h3><p class="text-center"><a href="<?php echo base_url(); ?>guru/formmencetak">Agenda Harian <?php echo $namatugas;?></a></p></h3>
...
$nomor =1;
	...
	{
	echo '<tr><td align="center" width="30">'.$nomor.'</td><td>'.date_to_long_string($d->tanggal).'</td><td>'.$d->namakegiatan.'</td><td>'.$d->tempat.'</td><td>'.$d->waktu.'</td><td>'.$d->keterangan.'</td></tr>';
	$nomor++;
	}

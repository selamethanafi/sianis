...
<tr><td>Pangkat/Jabatan/Golongan Awal Penilaian</td><td><?php echo $pangkat1.' / '.$jabatan1.' / '.$gol1;?>  <a href="<?php echo base_url();?>pkg/skskp">Ubah</a></td></tr>
...
if($permanen == 1)
	{
		echo '<a href="'.base_url().'pkg/tambahskp/hapus" class="btn btn-danger" data-confirm="Yakin hendak membatalkan SKP?"><b> Batalkan</b></a> ';
	}
	else
	{
	echo '<a href="'.base_url().'pkg/tambahskp/permanen" class="btn btn-info"><b>Jadikan Permanen</b></a> ';
	echo '<a href="'.base_url().'pkg/tambahskp/pkg" class="btn btn-info"><b>PKG</b></a> <a href="'.base_url().'pkg/tambahskp/pkb" class="btn btn-info"><b>PKB</b></a> <a href="'.base_url().'pkg/tambahskp/tugas" class="btn btn-info"><b>Tugas Relevan</b></a> <a href="'.base_url().'pkg/tambahskp/penunjang" class="btn btn-info"><b>Unsur Penunjang</b></a> ';
	}
if($permanen == 1)
	{
		echo '<a href="'.base_url().'pkg/realisasiskp" class="btn btn-info"><b>Realisasi</b></a> <a href="'.base_url().'sieka/unduhskp/'.$tahunsekarang.'" class="btn btn-success"><b>Unduh Sieka</b></a> '; 
	?>	
		Cetak <strong>&gt;&gt;&gt;</strong>&nbsp;<a href="javascript:;"  onClick="window.open('<?php echo base_url();?>pdf_report/cetakskp/<?php echo $tahunpenilaian.'/'.$nippegawai.'/borang';?>','yes','scrollbars=yes,width=550,height=400')" class="btn btn-success"><strong>Borang</strong></a><?php
	}
if($permanenkepala == 1)
	{
	?>&nbsp;<a href="javascript:;"  onClick="window.open('<?php echo base_url();?>pdf_report/cetakskp/<?php echo $tahunpenilaian.'/'.$nippegawai.'/penilaian';?>','yes','scrollbars=yes,width=550,height=400')" class="btn btn-success"><strong>Penilaian SKP</strong></a>&nbsp;<a href="javascript:;"  onClick="window.open('<?php echo base_url();?>pdf_report/cetakskp/<?php echo $tahunpenilaian.'/'.$nippegawai.'/perilaku/rekap';?>','yes','scrollbars=yes,width=550,height=400')" class="btn btn-success"><strong>Perilaku</strong></a>&nbsp;<a href="javascript:;"  onClick="window.open('<?php echo base_url();?>pdf_report/cetakskp/<?php echo $tahunpenilaian.'/'.$nippegawai.'/ppk';?>','yes','scrollbars=yes,width=550,height=400')" class="btn btn-success"><strong>PPK (DP3)</strong></a>&nbsp;<a href="javascript:;"  onClick="window.open('<?php echo base_url();?>pdf_report/cetakskp/<?php echo $tahunpenilaian.'/'.$nippegawai.'/sampul';?>','yes','scrollbars=yes,width=550,height=400')" class="btn btn-success"><strong>Sampul</strong></a>
		<?php
	}
	echo '</p>';
$nomor=1;
...
foreach($ta->result() as $a)
	...
	if(($a->kegiatan == 'Unsur utama') or ($a->kegiatan == 'Unsur Penunjang Tugas Guru') or ($a->kegiatan == 'Unsur PKB'))
		...
		{
			echo '<tr>';
			if(($a->kode == '00') or ($a->kode == '01'))
				{
					echo '<td align="center"><a href="'.base_url().'pkg/revisiskp/'.$a->id_skp_skor_guru.'" data-confirm="Anda yakin ingin mengubah capaian '.$a->kegiatan.'" title="Revisi capaian '.$a->kegiatan.'"><span class="fa fa-bullseye"></span></a></td>';
				}
			else
			{
				if($permanen != 1)
				{
				echo '<td align="center"><a href="'.base_url().'pkg/hapusskp/'.$a->id_skp_skor_guru.'" data-confirm="Anda yakin ingin menghapus data ini '.$a->kegiatan.'" title="Hapus Data '.$a->kegiatan.'"><span class="fa fa-trash-alt"></span></a></td>';
				}
				else
				{
				echo '<td align="center"><a href="'.base_url().'pkg/revisiskp/'.$a->id_skp_skor_guru.'" data-confirm="Anda yakin ingin mengubah capaian '.$a->kegiatan.'" title="Revisi capaian '.$a->kegiatan.'"><span class="fa fa-bullseye"></span></a></td>';
			...
			{
				echo '<td align="center"><a href="'.base_url().'pkg/realisasiskp/'.$a->id_skp_skor_guru.'" title="Realisasi SKP"><span class="fa fa-edit"></span></a></td>';
			}
			else
			{
				if($permanen != 1)
				{
				echo '<td align="center"><a href="'.base_url().'pkg/ubahskp/'.$a->id_skp_skor_guru.'" title="Ubah Data"><span class="fa fa-edit"></span></a></td>';
				}
				else
				{ echo '<td align="center"><a href="'.base_url().'pkg/realisasiskp/'.$a->id_skp_skor_guru.'" title="Realisasi SKP"><span class="fa fa-edit"></span></a></td>'; }

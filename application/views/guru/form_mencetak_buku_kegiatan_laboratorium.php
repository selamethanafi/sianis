...
<?php 
echo '<input type="hidden" name="yangdicetak" value="Buku Kegiatan Laboratorium"><input name="kodeguru" type="hidden" value="'.$kodeguru.'">';
?>
<?php
	echo '<div class="form-group row row"><div class="col-sm-3"><label class="control-label">Tahun Pelajaran</div><div class="col-sm-9">
	...
	echo '</select></div></div>';
	echo '<div class="form-group row row"><div class="col-sm-3"><label class="control-label">Semester</div><div class="col-sm-9">
	<select name="semester" class="form-control">';
	echo "<option value='".$semester."'>".$semester."</option>";
	echo "<option value='1'>1</option><option value='2'>2</option>";
	echo '</select></div></div>';
	echo '<div class="form-group row row"><div class="col-sm-3"><label class="control-label">Laboratorium</div><div class="col-sm-9">';

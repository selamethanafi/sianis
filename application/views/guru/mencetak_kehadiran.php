...
$lebartabel="100%";
?>
<h3><p class="text-center"><a href="<?php echo base_url();?>guru/formmencetak">Daftar Kehadiran Siswa</a></p></h3>
<?php
...
<?php
// judul kolom
$ttgl = $this->db->query("select * from guru_rph where thnajaran='$thnajaran' and semester='$semester' and mapel='$mapel' and kelas='$kelas' order by tanggal");

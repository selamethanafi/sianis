...
<div class="card-body">
<p><a href="<?php echo base_url(); ?>guru/nilai" class="btn btn-info"><span class="glyphicon glyphicon-arrow-left"></span> <b>Kelas Lain</b></a> 
	<?php
	...
	{
		echo ' <a href="'.base_url().'guru/afektif" class="btn btn-info"><b>Nilai Sikap</b></a>';
	}
	echo '</p>';
...
if($itemnilai != 4)
{
	...
	{
		echo '<p>Untuk memperbarui deskripsi sikap, klik <a href="'.base_url().'guru/deskripsisikap/'.$id_mapel.'" class="btn btn-primary">Perbarui Deskripsi Sikap</a></p><p>untuk mengunci nilai klik <a href="'.base_url().'guru/lck2/'.$id_mapel.'/4" title="Ubah Keterangan Ketuntasan atau mengunci nilai" class="btn btn-primary">di sini</a></p>';
	}
}
?>
<?php
...
if($kurikulum == '2013')
{
	...
	echo '<td width="25" rowspan="2"><strong>MID</strong></td><td width="'.$k345678.'" colspan="8"><strong>Nilai Rapor</strong></td><td width="'.$k3.'" rowspan="2"><strong>Kunci Nilai</strong></td><td rowspan="2"><a href="'.base_url().'guru/lck2/'.$id_mapel.'/4" title="Ubah Deskripsi Capaian Kompetensi atau mengunci nilai" class="btn btn-primary"><strong>Keterangan / Deskripsi / Kunci Nilai</strong></a>';
	if($jujug == 'Y')
	{
		echo '<tr align="center"><td width="'.$k3.'" colspan="3"><a href="'.base_url().'guru/nilaiharian/'.$id_mapel.'/13"><strong>Pengetahuan</strong></a></td><td width="'.$k34.'" colspan="3"><a href="'.base_url().'guru/nilaipsikomotor/'.$id_mapel.'/19"><strong>Keterampilan</strong></a></td><td width="'.$k34.'"><a href="'.base_url().'guru/daftarnilaiafektif/'.$id_mapel.'"><strong>Sikap</strong></a></td><td width="'.$k8.'"><strong>Ketuntasan</strong></td></tr>';
	}
	else
	{
		echo '<tr align="center"><td width="'.$k3.'" colspan="3" bgcolor="#fff"><a href="'.base_url().'guru/daftarnilai/'.$id_mapel.'"><strong>Pengetahuan</strong></a></td><td width="'.$k34.'" colspan="3"><a href="'.base_url().'guru/daftarnilaipsikomotor/'.$id_mapel.'"><strong>Keterampilan</strong></a></td><td width="'.$k34.'"><a href="'.base_url().'guru/daftarnilaiafektif/'.$id_mapel.'"><strong>Sikap</strong></a></td><td width="'.$k8.'"><strong>Ketuntasan</strong></td></tr>';
...
elseif(($kurikulum == 'KTSP') or ($kurikulum == '2015'))
{
	...
	if($ranah == 'KP')
	{
		echo '<td width="25" rowspan="2"><strong>MID</strong></td><td width="'.$k3456.'" colspan="3"><strong>Nilai Rapor</strong></td>';
		if($jujug == 'Y')
		{
		echo '<td rowspan="2" width="'.$k7.'"><strong>Rapor</strong></td><td rowspan="2">
		<a href="'.base_url().'guru/lck2/'.$id_mapel.'/4" title="Ubah Keterangan Ketuntasan atau mengunci nilai" class="btn btn-primary"><strong>Keterangan / Deskripsi / Kunci Nilai</strong></a></td></tr><tr align="center"><td width="25"><strong><a href="'.base_url().'guru/nilaiharian/'.$id_mapel.'/13">NS</a></strong></td><td width="25"><strong><a href="'.base_url().'guru/nilaipsikomotor/'.$id_mapel.'/19">NP*</a></strong></td><td width="30">TUNTAS</td></tr>';
		}
		else
		{
		echo '<td rowspan="2" width="'.$k7.'"><strong>Rapor</strong></td><td rowspan="2">
		<a href="'.base_url().'guru/lck2/'.$id_mapel.'/4" title="Ubah Keterangan Ketuntasan atau mengunci nilai" class="btn btn-primary"><strong>Keterangan / Deskripsi / Kunci Nilai</strong></a></td></tr><tr align="center"><td width="25"><strong><a href="'.base_url().'guru/daftarnilai/'.$id_mapel.'">NS</a></strong></td><td width="25"><strong><a href="'.base_url().'guru/daftarnilaipsikomotor/'.$id_mapel.'">NP*</a></strong></td><td width="30">TUNTAS</td></tr>';
		}

	}
	elseif($ranah == 'KA')
	{
		echo '<td width="25" rowspan="2"><strong>MID</strong></td><td width="'.$k78910.'" colspan="3"><strong>Nilai Rapor</strong></td>';
		if($jujug == 'Y')
		{
			echo '<td rowspan="2" width="'.$k7.'"><strong>Rapor</strong></td><td rowspan="2">
		<a href="'.base_url().'guru/lck2/'.$id_mapel.'/4" title="Ubah Keterangan Ketuntasan atau mengunci nilai" class="btn btn-primary"><strong>Keterangan / Deskripsi / Kunci Nilai</strong></a></td></tr><tr align="center"><td width="25"><strong><a href="'.base_url().'guru/nilaiharian/'.$id_mapel.'/13">NS</a></strong></td><td width="25"><strong><a href="'.base_url().'guru/daftarnilaiafektif/'.$id_mapel.'">AFE</a></strong><td width="30">TUNTAS</td></tr>';
		}
		else
		{
			echo '<td rowspan="2" width="'.$k7.'"><strong>Rapor</strong></td><td rowspan="2">
		<a href="'.base_url().'guru/lck2/'.$id_mapel.'/4" title="Ubah Keterangan Ketuntasan atau mengunci nilai" class="btn btn-primary"><strong>Keterangan / Deskripsi / Kunci Nilai</strong></a></td></tr><tr align="center"><td width="25"><strong><a href="'.base_url().'guru/daftarnilai/'.$id_mapel.'">NS</a></strong></td><td width="25"><strong><a href="'.base_url().'guru/daftarnilaiafektif/'.$id_mapel.'">AFE</a></strong><td width="30">TUNTAS</td></tr>';
		}

	}
	elseif($ranah == 'PA')
	{
		echo '<td width="'.$k78910.'" colspan="3"><strong>Nilai Rapor</strong></td>';
		echo '<td rowspan="2" width="'.$k7.'"><strong>Rapor</strong></td><td rowspan="2">
		<a href="'.base_url().'guru/lck2/'.$id_mapel.'/4" title="Ubah Keterangan Ketuntasan atau mengunci nilai" class="btn btn-primary"><strong>Keterangan / Deskripsi / Kunci Nilai</strong></a></td></tr><tr align="center"><td width="25"><strong><a href="'.base_url().'guru/daftarnilaipsikomotor/'.$id_mapel.'/19">NP*</a></strong></td><td width="25"><strong><a href="'.base_url().'guru/daftarnilaiafektif/'.$id_mapel.'">AFE</a></strong><td width="30">TUNTAS</td></tr>';
	}
	...
	else
	{
		if($jujug == 'Y')
		{
			echo '<td width="25" rowspan="2"><strong>MID</strong></td><td width="'.$k78910.'" colspan="4"><strong>Nilai Rapor</strong></td>';
			echo '<td rowspan="2" width="'.$k7.'"><strong>Rapor</strong></td><td rowspan="2">
		<a href="'.base_url().'guru/lck2/'.$id_mapel.'/4" title="Ubah Keterangan Ketuntasan atau mengunci nilai" class="btn btn-primary"><strong>Keterangan / Deskripsi / Kunci Nilai</strong></a></td></tr><tr align="center"><td width="25"><strong><a href="'.base_url().'guru/nilaiharian/'.$id_mapel.'/13">NS</a></strong></td><td width="25"><strong><a href="'.base_url().'guru/nilaipsikomotor/'.$id_mapel.'/19">NP*</a></strong></td><td width="25"><strong><a href="'.base_url().'guru/daftarnilaiafektif/'.$id_mapel.'">AFE</a></strong><td width="30">TUNTAS</td></tr>';
		}
		else
		{
			echo '<td width="25" rowspan="2"><strong>MID</strong></td><td width="'.$k78910.'" colspan="4"><strong>Nilai Rapor</strong></td>';
...
{
	echo '<td width="'.$k345678.'" colspan="6"><strong></strong></td><td width="'.$k91011121314.'" colspan="6"><strong>Nilai Rapor</strong></td><td width="'.$k15.'" rowspan="2"><strong>r</strong></td><td rowspan="2"></td></tr>';
echo '<tr align="center"><td width="'.$k34.'" colspan="2" bgcolor="#fff"></td><td width="'.$k34.'" colspan="2"></td><td width="'.$k5.'"></td><td width="'.$k6.'"></td><td width="'.$k910.'" colspan="2" bgcolor="#fff"></td><td width="'.$k910.'" colspan="2"></td><td width="'.$k11.'"></td><td width="'.$k12.'"></td></tr>';
...
foreach($ta->result() as $a)
{
	...
	$tf = $this->db->query("select * from `nilai` where `thnajaran`='$thnajaran' and `semester`='$semester' and `mapel`='$mapel' and `nis`= '$nis' and status='Y' order by no_urut ");
	if($tf->num_rows() > 0)
	{
		...
		foreach($tf->result() as $t)
		{
			...
			{
				$predikat_nilai_nr = predikat_nilai_2015($nilai_nr,$this->config->item('versi_predikat_nilai'));
			}
			else
			{
			...
			if($this->config->item('predikat_nilai') == '2015')
			{
				$predikat_kog = predikat_nilai_2015($kog,$this->config->item('versi_predikat_nilai'));
			}
			else
			{
			...
			if($this->config->item('predikat_nilai') == '2015')
			{
				$predikat_psikomotor = predikat_nilai_2015($psikomotor,$this->config->item('versi_predikat_nilai'));
			}
			else
			{
			...
			if($this->config->item('predikat_nilai') == '2015')
			{
				$predikat_psi = predikat_nilai_2015($psi,$this->config->item('versi_predikat_nilai'));
			}
			else
			{
			...
			if($kog < $kkm)
			{
				if($this->config->item('predikat_nilai') == '2015')
				{
					$predikat_kog = '<p class="text-danger">'.predikat_nilai_2015($kog,$this->config->item('versi_predikat_nilai')).'</p>';
					$kkog = '<p class="text-danger">'.konversi_nilai($kog).'</p>';		
				}
				else
				{
					$predikat_kog = '<p class="text-danger">'.predikat_nilai($kog).'</p>';
					$kkog = '<p class="text-danger">'.konversi_nilai($kog).'</p>';		
				}
			...
			if($psi < $kkm)
			{
				if($this->config->item('predikat_nilai') == '2015')
				{
					$predikat_psi = '<p class="text-danger">'.predikat_nilai_2015($psi,$this->config->item('versi_predikat_nilai')).'</p>';
				$kpsi = '<p class="text-danger">'.konversi_nilai($psi).'</p>';		
				}
				else
				{
					$predikat_psi = '<p class="text-danger">'.predikat_nilai($psi).'</p>';
					$kpsi = '<p class="text-danger">'.konversi_nilai($psi).'</p>';		
				}
		...
		if($kurikulum == '2013')
		{
			...
			echo '<td align="center">'.$kog.'</td><td align="center">'.$kkog.'</td>';
			echo '<td align="center">'.$predikat_kog.'</td>';
			echo '<td align="center">'.$psi.'</td><td align="center">'.$kpsi.'</td>';
		...
		{
			echo '<input type="text" name="keterangan_'.$nomor.'" value ="'.$t->keterangan.'" class="form-control">';
		}
	...
	//keterampilan
	$ketpsi = $t->deskripsi;
	$tk = $this->db->query("select * from `afektif` where `mapel`='$mapel' and thnajaran='$thnajaran' and kelas='$kelas' and semester='$semester' and nis='$nis'");
	$ketafe = '';
	...
	echo '<td><input type="hidden" name="keterangan_'.$nomor.'" value ="'.$t->keterangan.'">';
	if($kurikulum == '2015')
	{
		echo '<strong>Pengetahuan</strong> : '.$t->keterangan.'<br /><strong>Keterampilan</strong> : '.$ketpsi;
	}
	elseif($kurikulum == '2013')
	{
		echo '<strong>Pengetahuan</strong> : '.$t->keterangan.'<br /><strong>Keterampilan</strong> : '.$ketpsi.'<br /><strong>Sikap</strong> : '.$ketafe;
	}
	else
	{
		if($ranah == 'KPA')
		...
		{
			echo '<strong>Ranah penilaian tidak sesuai';
		}
	}
	echo '</td>';
/*
	if($t->rapor == '1')
	{
		$this->db->query("update `nilai` set `kunci` = '1' where `kd`='$id_nilai'");
	}
*/
	}
	echo '</tr>';

...
<?php 
echo '<input type="hidden" name="yangdicetak" value="Buku Pelaksanaan Kegiatan Tugas Tambahan"><input name="kodeguru" type="hidden" value="'.$kodeguru.'">';
?>
<?php
	...
	echo '</select></div></div>';
	echo '<p class="text-center"><input type="hidden" name="diproses" value="oke"><input type="submit" value="Cetak Buku Pelaksanaan Kegiatan Tugas Tambahan" class="btn btn-primary">&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guru/formmencetak" class="btn btn-info"><b>Batal</b></a></p>';
?>
</form>
</div></div></div>

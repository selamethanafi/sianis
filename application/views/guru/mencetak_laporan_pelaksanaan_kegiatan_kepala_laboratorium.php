...
$lebartabel="100%";
?>
<h3><p class="text-center"><a href="<?php echo base_url(); ?>guru/formmencetak">Buku Laporan Pelaksanaan Kegiatan <?php echo $namatugas;?></a></p></h3>
...
<tr align="center"><td rowspan="2"><strong>No.</strong></td><td rowspan="2"><strong>Tanggal</strong></td><td rowspan="2"><strong>Nama Kegiatan</strong></td><td rowspan="2"><strong>Waktu</strong></td><td colspan="2"><strong>Tingkat Ketercapaian</strong><td rowspan="2"><strong>Keterangan</strong></td></tr><tr align="center"><td><strong>Terlaksana</strong></td><td><strong>Persentase</strong></td></tr>';
$nomor =1;
	foreach ($trph->result() as $d)
	{
	echo '<tr valign="top"><td align="center">'.$nomor.'</td><td>'.date_to_long_string($d->tanggal).'</td><td>'.$d->namakegiatan.'</td><td>'.$d->waktu.'</td><td>'.$d->terlaksana.'</td><td>'.$d->persentase.'</td><td>'.$d->keterangan_pelaksanaan.'</td></tr>';
	$nomor++;
	}

...
if (!empty($ditandatangani))
	...
	echo '<div class="form-group row row"><div class="col-sm-3"><label class="control-label">Ditandatangani kepala</label></div><div class="col-sm-9">';
			...
			echo '<p class="form-control-static">'.$ditandatangani.'</p></div"></div>';
	}
...
if (empty($thnajaran))
	...
	echo '</select><p class="text-warning"><strong> Pilih tahun pelajaran</strong></p></div></div>';
	echo '<p class="text-center"><input type="submit" value="Lanjut" class="btn btn-primary">&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guru/formmencetak"><b>Batal</b></a></p>';
	}
...
elseif (empty($semester))
	...
	<select name="semester" class="form-control">';
		...
		echo '<option value="2">2</option></select><p class="text-warning"><strong> Pilih semester</strong></p></div></div>';
		echo '<p class="text-center"><input type="submit" value="Lanjut" class="btn btn-primary">&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guru/formmencetak"><b>Batal</b></a></p>';
...
elseif (empty($ditandatangani))
{
	...
	echo '</select><p class="text-warning"><strong> Pilih ditandatangani kepala?</strong><div class="form-group row row"><div class="col-sm-3"><label class="control-label">';
	echo '<p class="text-center"><input type="submit" value="Lanjut" class="btn btn-primary">&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guru/formmencetak"><b>Batal</b></a></p>';
}

else
{
	echo '<p class="text-center"><input type="hidden" name="diproses" value="oke"><input type="submit" value="Cetak Rencana Pelaksanaan Harian" class="btn btn-primary">&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guru/formmencetak"><b>Batal</b></a></p>';
}
?>
</form>
</div></div></div>

...
//============================================================+
// Nama Berkas : form_mencetak_daftar_tugas.php
...
<?php 
echo '<input type="hidden" name="yangdicetak" value="Buku Tugas Versi 2"><input name="kodeguru" type="hidden" value="'.$kodeguru.'">';
	...
	echo '</select></div></div>';
	echo '<p class="text-center"><input type="hidden" name="diproses" value="oke"><input type="submit" value="Cetak Buku Tugas" class="btn btn-primary">&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guru/formmencetak" class="btn btn-info"><b>Batal</b></a></p>';
?>
</form>
</div></div></div>

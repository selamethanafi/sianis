...
// Nama Berkas 		: form_mencetak_akhlak.php
...
<div class="card-body">
<?php echo form_open('guru/formmencetak/'.$noyangdicetak.'/17','class="form-horizontal" role="form"');?>
<?php 
echo '<input type="hidden" name="yangdicetak" value="Daftar Nilai Akhlak"><input name="kodeguru" type="hidden" value="'.$kodeguru.'">';
?>
<?php
if (!empty($thnajaran))
	{
...
else
{
	...
	echo '<input type="hidden" name="diproses" value="oke"><input type="submit" value="Cetak Daftar Nilai Akhlak" class="btn btn-primary">&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guru/formmencetak" class="btn btn-info"><b>Batal</b></a></p>';
}
?>
</form>
</div></div></div>

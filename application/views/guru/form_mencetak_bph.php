...
<?php 
echo '<input type="hidden" name="yangdicetak" value="Buku Pelaksanaan Harian"><input name="kodeguru" type="hidden" value="'.$kodeguru.'">';
?>
<table>
<?php
if (!empty($thnajaran))
...
elseif (empty($id_mapel))
{
	...
	echo '<option value="Semua">Semua Mapel Semua Kelas</option>';
	foreach($tmapel->result_array() as $dm)
		{
...
{
	echo '<p class="text-center"><input type="hidden" name="diproses" value="oke"><input type="submit" value="Cetak Buku Pelaksanaan Harian" class="btn btn-primary">&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guru/formmencetak" class="btn btn-info"><b>Batal</b></a></p>';
}
?>
</table>
</form>

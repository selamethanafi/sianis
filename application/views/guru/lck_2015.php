...
if($ta->num_rows()>0)
{
	...
	echo '<td width="25" rowspan="2"><strong>MID</strong></td><td width="'.$k345678.'" colspan="5"><strong>Nilai Rapor</strong></td><td width="'.$k3.'" rowspan="2"><strong>Kunci Nilai</strong></td><td rowspan="2"><a href="'.base_url().'guru/lck2/'.$id_mapel.'/4" title="Ubah Deskripsi Capaian Kompetensi atau mengunci nilai" class="btn btn-primary"><strong>Keterangan / Deskripsi / Kunci Nilai</strong></a>';
	if($jujug == 'Y')
	{

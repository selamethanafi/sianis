...
//============================================================+
// Nama Berkas : form_mencetak_daftar_nilai_afektif.php
...
?>
<?php
$namamodul = 'Daftar Nilai Afektif';
?>
...
elseif (empty($id_mapel))
{
	...
	echo '<div class="form-group row row"><div class="col-sm-3"><label class="control-label">Mata Pelajaran / Kelas</label></div><div class="col-sm-9"><p class="form-control-static">';

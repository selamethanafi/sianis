...
<div class="card-body">
	...
	if(!empty($halaman_depan))
		...
		<div class="form-group row">
				...
				<div class="form-group row"><div class="col-sm-3"><label class="control-label">Besar pembayaran</label></div><div class="col-sm-3"><input name="besar" type="text" id="rupiah" class="form-control" required> </div>

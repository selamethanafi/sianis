...
<div class="container-fluid">
 <h1>Proses Pengajuan Izin Meninggalkan Madrasah</h1>
	<div class="alert alert-info"><h2>Borang ini bisa digunakan beberapa siswa sekaligus dengan syarat <strong>kelas</strong>, <strong>waktu</strong>, dan <strong>kembali ke madrasah</strong> harus <strong>sama</strong></h2></div>
	<div class="well">
	<form action="<?php echo base_url();?>aim/prosesizin" method="post">
		<div class="form-group row">
			<div class="col-sm-3"><label class="control-label">Nama</label></div>
			<div class="col-sm-9" ><select id="nis" name="nis[]" class="form-control" multiple="multiple" required autofocus>
					<option value=""></option>
					<?php
		...
		<div class="form-group row">
			...
			<div class="col-sm-9" ><p class="form-control-static"><?php echo $namahari.' '.tanggal(tanggal_hari_ini());?></p>
			</div>
		</div>
	 	<div class="form-group row">
			<div class="col-sm-3"><label class="control-label">Jam ke *</label></div>
			<div class="col-sm-9" ><input type="text" name="jamke" class="form-control" placeholder="jam pelajaran yang ditinggalkan" required>
			</div>
		</div>
	 	<div class="form-group row">
			<div class="col-sm-3"><label class="control-label">Alasan Meninggalkan Madrasah *</label></div>
			<div class="col-sm-9" ><input type="text" name="alasan" class="form-control" placeholder="masukkan alasan Anda meninggalkan madrasah" required>
			</div>
		</div>
	 	<div class="form-group row">

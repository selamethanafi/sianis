...
//============================================================+
?>
<div class="container-fluid"><h3><?php echo $judulhalaman;?> 2018</h3>
<?php
echo $keterangan;
if(empty($nis))
{
...
else
{
	...
	<div class="form-group row"><div class="col-sm-3"><label class="control-label">Pilih siswa</label></div><div class="col-sm-9"><select name="nis" onChange="MM_jumpMenu('self',this,0)" class="form-control">
	<?php

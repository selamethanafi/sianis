...
//============================================================+
// Dimutakhirkan	: Jum 18 Mei 2018 04:20:38 WIB 
// Nama Berkas 		: mapel_per_ruang
...
{
$xloc = base_url().'pengajaran/mapelperruang/tampil';
...
{
	$tahun1 = substr($thnajaran,0,4);
	echo '<a href="'.base_url().'pengajaran/mapelperruang/tambah/'.$tahun1.'/'.$semester.'/'.$id_kelas.'" class="btn btn-info" role="button"><span class="fa fa-plus"></span> Pembagian Tugas Guru</a><p> </p>';
	$daftar_mapel= $this->Pengajaran_model->Tampil_Mapel_Thnajaran_Ruang($thnajaran,$kelas);
?>
<div class="table-responsive"><table class="table table-hover table-striped table-bordered">
<tr align="center"><td width="30"><strong>No.</strong></td><td><strong>Thnajaran</strong></td><td><strong>Semester</strong></td><td><strong>Kelas</strong></td><td><strong>Mapel</strong></td><td><strong>JTM</strong></td><td><strong>Nama Guru</strong></td><td colspan="2"><strong>Aksi</strong></td></tr>
<?php
$nomor=1;
...
<td>".$b->mapel."</td>
<td align=\"center\">".$b->jam."</td>
<td align=\"center\">".cari_nama_pegawai($b->kodeguru)."</td>
<td align=\"center\"><a href=".base_url()."pengajaran/mapelperruang/ubah/".substr($thnajaran,0,4)."/".$semester."/".$id_kelas."/".$b->id_mapel."><span class=\"fa fa-edit\"></span></a></td><td align=\"center\">";
echo "<a href='".base_url()."pengajaran/mapelperruang/hapus/".substr($thnajaran,0,4)."/".$semester."/".$id_kelas."/".$b->id_mapel."' onClick=\"return confirm('Anda yakin ingin menghapus record ini?')\" title='Hapus'><span class=\"fa fa-trash-alt\"></span></a></td>";
echo "</tr>";
$nomor++;
	}
}

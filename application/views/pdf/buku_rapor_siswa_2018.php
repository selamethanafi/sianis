...
$this->fpdf->SetTitle("buku rapor permen 53 tahun 2015 sianis rilis 2018");
			...
			if($adanilai>0)
			{
				foreach($tc->result() as $c)
				{
					...
					if($status_nilai == 'akhir')
					{
						...
						$this->fpdf->Cell($k5,$selisih,predikat_nilai_2018($c->kog,$kkm),1,0,'C',0);
						$this->fpdf->Cell($k6,$selisih,$c->psi,1,0,'C',0);
						$this->fpdf->Cell($k7,$selisih,predikat_nilai_2018($c->psi,$kkm),1,2,'C',0);
						}
					}
					elseif($status_nilai == 'sementara')
					{
						...
						$this->fpdf->Cell($k5,$selisih,predikat_nilai_2018($c->nilai_nr,$kkm),1,0,'C',0);
						$this->fpdf->Cell($k6,$selisih,$c->psikomotor,1,0,'C',0);
						$this->fpdf->Cell($k7,$selisih,predikat_nilai_2018($c->psikomotor,$kkm),1,2,'C',0);
					}
					else
					{

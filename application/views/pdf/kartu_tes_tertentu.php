...
$this->fpdf->cell($lkori,4,'',0,2,'C',0);
$this->fpdf->cell($lkori,4,'',0,2,'C',0);
$this->fpdf->setFont('Times','B',6);
$this->fpdf->cell($lkori,4,'',0,2,'C',0);
$this->fpdf->setFont('Times','B',8);
$this->fpdf->SetXY($kiri,$ygrskiri);
$this->fpdf->Cell($lkori,0, '', 0, 0, 'C', 0);
...
$this->fpdf->cell($lkori-30,8,'',0,2,'C',0);
$this->fpdf->cell($lkori-30,8,'',0,2,'C',0);
...
$this->fpdf->Image('images/ttd/'.$ttdkepala.'',120,$yyy,25,10);
...
$this->fpdf->Cell($lkori, $a, '', 0, 0, 'C', 0);$this->fpdf->SetXY(88,5);$this->fpdf->Cell(118, $a, '', 1, 1, 'C', 0);
}
if ($kali==2)
{
$this->fpdf->SetXY($kiri,75);
$this->fpdf->Cell($lkori, $a, '', 0, 1, 'C', 0);$this->fpdf->SetXY(88,75);$this->fpdf->Cell(118, $a, '', 1, 1, 'C', 0);
}
if ($kali==3)
{
$this->fpdf->SetXY($kiri,146);
$this->fpdf->Cell($lkori, $a, '', 0, 1, 'C', 0);$this->fpdf->SetXY(88,146);$this->fpdf->Cell(118, $a, '', 1, 1, 'C', 0);
}
if ($kali==4)
{
$this->fpdf->SetXY($kiri,216);
$this->fpdf->Cell($lkori, $a, '', 0, 1, 'C', 0);$this->fpdf->SetXY(88,216);$this->fpdf->Cell(118, $a, '', 1, 1, 'C', 0);
}
...
$this->fpdf->Output("kartu_tes_perorangan.pdf","I");
}
else
{
echo "Tidak ada data ";

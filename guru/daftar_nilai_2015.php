...
echo '<a href="'.base_url().'guru/statusketuntasan/'.$id_mapel.'" class="btn btn-success"><b>PROSES DESKRIPSI RAPOR</b></a> <a href="'.base_url().'guruard/kirimnilai/'.$id_mapel.'" class="btn btn-success"><b>KIRIM KE ARD</b></a></p> ';
?>

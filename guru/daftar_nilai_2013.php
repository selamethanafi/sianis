...
if($jujug == 'T')
{
	echo '<td colspan="2"><strong>NR</strong></td></tr>';
}
else
{
	echo '<td colspan="2"><a href="'.base_url().'guru/nilaiharian/'.$id_mapel.'/13" title="Ubah Nilai Rapor"><strong>NR</strong></a></td></tr>';
}
?>
</thead>
<?php

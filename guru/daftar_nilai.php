...
if($mapel == 'Bimbingan Teknologi Informasi dan Komunikasi')
{$pilihan = '0';
}
if($pilihan == '1')
{
...
<div class="form-group row"><div class="col-sm-5"><label class="control-label">Status Mata Pelajaran</label></div><div class="col-sm-7"><p class="form-control-static"><?php echo $pilihane;?></div></div>
</form>
<?php
/*
...
else
{
	if($kurikulum == '2013')
	{
	echo '<td colspan="2"><a href="'.base_url().'guru/nilaiharian/'.$id_mapel.'/13" title="Ubah Nilai Akhir"><strong>NS</strong></a></td></tr>';
	}
	else
	{
	echo '<td><a href="'.base_url().'guru/nilaiharian/'.$id_mapel.'/13" title="Ubah Nilai Akhir" data-confirm="Apakah nilai keterampilan sudah diproses? Jika belum, sebaiknya menyelesaikan nilai keterampilan dahulu."><strong>NS</strong></a></td></tr>';
	}
}
?>
</thead>

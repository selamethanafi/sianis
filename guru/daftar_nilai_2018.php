...
$tw = $this->db->query("select * from `m_walikelas` where `thnajaran`='$thnajaran' and `semester`='$semester' and `kelas`='$kelas'");
$school_class_id = '';
foreach($tw->result() as $w)
{
	$school_class_id = $w->kode_rombel;
}
...
{
	$this->db->query("update `nilai` set `kd_mapel` = '$no_urut_mapel' where `thnajaran`='$thnajaran' and `semester`='$semester' and `kelas`='$kelas' and `mapel` = '$mapel'");
}
if($pilihan == 1)
{
...
{
	echo '<p><a href="'.base_url().'guru/nilailama/" class="btn btn-primary"><span class="fa fa-arrow-left"></span> <b>Kelas Lain Semester Lalu</b></a>&nbsp;&nbsp;&nbsp;&nbsp;';
}
else
{
	echo '<p><a href="'.base_url().'guru/nilai/" class="btn btn-primary"><span class="fa fa-arrow-left"></span> <b>Kelas Lain</b></a>&nbsp;&nbsp;&nbsp;&nbsp;';
}
...
echo '<a href="'.base_url().'guru/statusketuntasan/'.$id_mapel.'" class="btn btn-success"><b>PROSES DESKRIPSI RAPOR</b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guruard/kirimnilai/'.$id_mapel.'" class="btn btn-success" target="_blank"><b>KIRIM NILAI HARIAN KE ARD</b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="'.base_url().'guruard/kirimnilaiakhir/'.$id_mapel.'" class="btn btn-danger" target="_blank"><b>KIRIM NILAI AKHIR KE ARD</b></a></p> ';
?>
...
<div class="form-group row"><div class="col-sm-5"><label class="control-label">Bobot Ulangan Harian + Bobot Kuis + Bobot Tugas + Mid + Semester</label></div><div class="col-sm-7"><p class="form-control-static"><?php 
...
<div class="form-group row"><div class="col-sm-5"><label class="control-label">Kode Kurikulum</label></div><div class="col-sm-7"><p class="form-control-static"><?php echo $kurikulum;?></div></div>
<div class="form-group row"><div class="col-sm-5"><label class="control-label">Status Mata Pelajaran</label></div><div class="col-sm-7"><p class="form-control-static"><?php echo $pilihan.' '.$pilihane;?></div></div>
...
{
	echo '<td><a href="'.base_url().'guru/nilaiharian/'.$id_mapel.'/13" title="Ubah Nilai Akhir" data-confirm="Apakah nilai keterampilan sudah diproses? Jika belum, sebaiknya menyelesaikan nilai keterampilan dahulu. Lanjut?"><strong>NS</strong></a></td></tr>';
...
if ($rata_nilai_uh1 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh1 < $persentase_klasikal)
		{
		$klasikal1='Y';
		}
		else
...
if ($rata_nilai_uh2 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh2 < $persentase_klasikal)
		{
		$klasikal2='Y';
		}
		else
...
if ($rata_nilai_uh3 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh3 < $persentase_klasikal)
		{
		$klasikal3='Y';
		}
		else
...
if ($rata_nilai_uh4 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh4<$persentase_klasikal)
		{
		$klasikal4='Y';
		}
		else
...
if ($rata_nilai_uh5 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh9<$persentase_klasikal)
		{
		$klasikal9='Y';
		}
		else
...
if ($rata_nilai_uh6 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh10<$persentase_klasikal)
		{
		$klasikal10='Y';
		}
		else
...
if ($rata_nilai_uh7 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh11<$persentase_klasikal)
		{
		$klasikal11='Y';
		}
		else
...
if ($rata_nilai_uh8 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh12<$persentase_klasikal)
		{
		$klasikal12='Y';
		}
		else
...
if ($rata_nilai_uh9 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh13<$persentase_klasikal)
		{
		$klasikal13='Y';
		}
		else
...
if ($rata_nilai_uh10 > 0 )
	 {
	if ($persentase_di_atas_kkm_uh14<$persentase_klasikal)
		{
		$klasikal14='Y';
		}
		else
...
if ($rata_nilai_mid > 0 )
	 {
	if ($persentase_di_atas_kkm_mid < $persentase_klasikal)
		{
		$klasikal5='Y';
		}
		else
...
if ($rata_nilai_uas > 0 )
	 {
	if ($persentase_di_atas_kkm_uas < $persentase_klasikal)
		{
		$klasikal6='Y';
		}
		else
...
if ($rata_nilai_na > 0 )
	 {
	if ($persentase_di_atas_kkm_na < $persentase_klasikal)
		{
		$klasikal7='Y';
		}
		else
...
if ($rata_nilai_nr > 0 )
	 {
	if ($persentase_di_atas_kkm_nr < $persentase_klasikal)
		{
		$klasikal8='Y';
		}
		else
...
echo '* : Klasikal bila persentase cacah siswa di atas kkm &gt; '.$persentase_klasikal.'%<br />';

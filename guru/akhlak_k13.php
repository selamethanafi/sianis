...
<div class="container-fluid"><div class="card">
	...
	<div class="card-body">
<div class="alert alert-info"><strong>Info.</strong> Bila belum terdapat data penilaian akhlak mulia, silakan hubungi BP atau mungkin data terdapat di halaman<a href="<?php echo base_url();?>guru/nilaiakhlak" class="btn btn-success">I N I</a></div>
<?php
$nomor=$page+1;
if($adadata>0){
?>
